...
Route::middleware('auth')->group(function () {
    ...
    //% Diseases
    Route::name('diseases.')->group(function () {
    ...
    //% Search diseases
    Route::get('/search-disease', SearchDiseaseController::class)->name('search.disease');
    //% Search treatments
    Route::get('/search-treatment', SearchTreatmentController::class)->name('search.treatment');
    //% Search notes
    Route::get('/search-note', SearchNoteController::class)->name('search.note');
});
