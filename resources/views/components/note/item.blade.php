@props(['noteRoute', 'noteName', 'noteCreatedAt', 'noteUpdatedAt'])
...
<li class="flex justify-between gap-x-6 py-5">
    ...
    <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
        <p class="mt-1 text-xs leading-5 text-gray-500">{{ __("Created") }}: {{ $noteCreatedAt }}</p>
        <p class="mt-1 text-xs leading-5 text-gray-500">{{ __("Updated") }}: {{ $noteUpdatedAt }}</p>
    </div>
</li>
