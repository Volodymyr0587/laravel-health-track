...
<li>
    <a href="{{ route($routeName) }}"
       class="{{ request()->routeIs($routeName) ? 'font-extrabold bg-gray-700 dark:bg-gray-700' : '' }} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        {{ $slot }}
