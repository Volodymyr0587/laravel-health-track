...
<li class="flex justify-between gap-x-6 py-5">
    <div class="flex min-w-0 gap-x-4">
        ...
        <div class="min-w-0 flex-auto">
            <p class="text-base truncate font-semibold leading-6 text-healthtrack-light dark:text-healthtrack-dark">{{ $eventName }}</p>
            <a href="{{ $eventRoute }}"
    ...
    <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
        <p class="text-sm leading-6 text-gray-900">{{ __("Price") }}: {{ $eventPrice }}</p>
